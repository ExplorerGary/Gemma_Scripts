...
SCRIPT_PATH_FULL="/gpfsnyu/scratch/zg2598/Gemma/gemma-3-4b-pt/Gemma_Scripts/Gemma_Full_SFT_test_truncate.py"
SCRIPT_PATH_LORA="/gpfsnyu/scratch/zg2598/Gemma/gemma-3-4b-pt/Gemma_Scripts/Gemma_Lora_SFT_test_truncate.py"
...
MODES=(fp12 fp8_e4m3 fp8_e5m2 fp4_e1m2 fp4_e2m1 fp4_e3m0)
...
for Mode in "${MODES[@]}"; do
    ...
    echo "Finished run with Mode=${Mode}"
    echo "==============================="
    echo ""
done
